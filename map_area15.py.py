...
def create_map(station_coords, amenities=None):
    # Initialize the map centered on downtown DC with a zoom level to show all metro stops
    m = folium.Map(
        location=[38.89511, -77.03637], 
        zoom_start=11,  # Adjust zoom level to ensure all metro stops are visible
